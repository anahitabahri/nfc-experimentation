...
const TRACKS = [
  { file: `${SONGZ}/David Guetta - Memories (Featuring Kid Cudi;clean Version).m4a`, title: "Memories",               artist: "David Guetta ft. Kid Cudi" },
  { file: `${SONGZ}/I'm Good (Blue) (Clean) - David Guetta, Bebe Rexha ｜ Lyric Video.m4a`, title: "I'm Good (Blue)",  artist: "David Guetta & Bebe Rexha" },
  { file: `${SONGZ}/Marshmello, Khalid - Numb (Audio).m4a`,                          title: "Numb",                   artist: "Marshmello & Khalid" },
  { file: `${SONGZ}/The Chainsmokers & Coldplay - Something Just Like This (Official Lyric Video).m4a`, title: "Something Just Like This", artist: "The Chainsmokers & Coldplay" },
];
