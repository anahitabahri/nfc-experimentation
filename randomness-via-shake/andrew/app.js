// ====== andrew — sound wall + shake-to-shuffle ======
// Songs are loaded from ./songs.

const SONGZ = "songs";

const TRACKS = [
  { file: `${SONGZ}/Bad Blood.m4a`,                                            title: "Bad Blood",          artist: "Taylor Swift" },
  { file: `${SONGZ}/Enter Sandman (Remastered).m4a`,                           title: "Enter Sandman",      artist: "Metallica" },
  { file: `${SONGZ}/Idina Menzel - Let It Go (from ＂Frozen＂) (Audio).m4a`,    title: "Let It Go",          artist: "Idina Menzel" },
  { file: `${SONGZ}/Thriller.m4a`,                                             title: "Thriller",           artist: "Michael Jackson" },
];
