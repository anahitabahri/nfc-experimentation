...
const TRACKS = [
  { file: `${SONGZ}/Kelly Clarkson - Because of You (Audio).m4a`,                  title: "Because of You",                  artist: "Kelly Clarkson" },
  { file: `${SONGZ}/Kelly Clarkson - Catch My Breath (Audio).m4a`,                 title: "Catch My Breath",                 artist: "Kelly Clarkson" },
  { file: `${SONGZ}/Kelly Clarkson - Mr. Know It All (Audio).m4a`,                 title: "Mr. Know It All",                 artist: "Kelly Clarkson" },
  { file: `${SONGZ}/Kelly Clarkson - Stronger (What Doesn't Kill You) (Audio).m4a`, title: "Stronger (What Doesn't Kill You)", artist: "Kelly Clarkson" },
  { file: `${SONGZ}/Miss Independent.m4a`,                                          title: "Miss Independent",                 artist: "Kelly Clarkson" },
];
